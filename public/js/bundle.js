...
var deleteExpiredBookingBtn = document.querySelectorAll('.btn-very-small.delete-expired-booking');
...
_toConsumableArray(deleteExpiredBookingBtn).forEach(function (item) {
  try {
    item.addEventListener('click', function (e) {
      e.preventDefault();
      var confirmation = confirm("Delete expired booking from 'My bookings'?");
      if (confirmation) item.parentElement.parentElement.style.display = 'none';
      (0, _alerts.showAlert)('success', 'Booking deleted from list!');
    });
  } catch (err) {
    (0, _alerts.showAlert)('error', err.response.data.message);
  }
});
},{"./mapbox.js":"mapbox.js","./login.js":"login.js","./signup.js":"signup.js","./updateSettings.js":"updateSettings.js","./stripe.js":"stripe.js","./alerts.js":"alerts.js","./additionalInfo.js":"additionalInfo.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
